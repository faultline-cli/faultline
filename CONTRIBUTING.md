...
5. Run `make docs-generate` after adding or modifying playbooks to regenerate the failure catalog pages and `docs/failures/llms.txt`.
6. Run `make fixture-check` if fixture or ranking behavior changes.
