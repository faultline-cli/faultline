...
var CommandSurfaces = []CommandSurface{
	...
	{Path: "workflow explain", Category: SurfaceCore, Maturity: MaturitySupported, HiddenFlags: []string{"no-history", "no-store", "store"}},
	{Path: "workflow apply", Category: SurfaceCompanion, Maturity: MaturitySupported, HiddenFlags: []string{"no-history", "no-store", "store"}},
	{Path: "workflow show", Category: SurfaceTransitional, Maturity: MaturityHidden, Hidden: true, HiddenFlags: []string{"no-history", "no-store", "store"}},
	{Path: "workflow history", Category: SurfaceTransitional, Maturity: MaturityHidden, Hidden: true, HiddenFlags: []string{"no-history", "no-store", "store"}},
	...
	{Path: "inspect", Category: SurfaceCompanion, Maturity: MaturitySupported},
	...
	{Path: "batch", Category: SurfaceCompanion, Maturity: MaturitySupported},
