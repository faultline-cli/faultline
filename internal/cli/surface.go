...
var CommandSurfaces = []CommandSurface{
	...
	{Path: "auth", Category: SurfaceCompanion, Maturity: MaturitySupported},
	{Path: "auth login", Category: SurfaceCompanion, Maturity: MaturitySupported},
	{Path: "auth logout", Category: SurfaceCompanion, Maturity: MaturitySupported},
