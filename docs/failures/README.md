...
**[docs/failures/catalog/README.md](catalog/README.md)** — all 173 bundled playbooks, generated directly from the playbook YAML. Every failure category is indexed with links to its dedicated diagnosis and fix page.
